...
<html>
	...
	<body>
		...
		<div id="ang-pageWrap">
			...
			<div id="ang-wrapper">
				<?php include '../_/inc/sidebar-result.php' ?>
				<section>
					<!-- start: panels -->
					<div id="ang-mainContent">			
						...
						<div id="ang-pSEventTable" class="ang-panelWide">
							...
							<div class="ang-pContent">
								<table id="ang-EventList" class="ang-ResultsList" summary="List of Alumni Results">
									<thead>
										<tr>
											<th>&nbsp;</th>
									...
									<tbody>
										<tr onclick="window.location='profile-view.php'">
