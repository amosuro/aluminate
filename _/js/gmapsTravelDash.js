$(document).ready(function (){
	function travelDashMap() {
		...
		map = new google.maps.Map(document.getElementById("ang-travelMap"), myOptions);
		...
		geocoder.geocode( { 'address': address}, function(results, status) {
			...
			var infowindow = new google.maps.InfoWindow({
				content: "<div class='ang-gmapsInfo'><img src='../_/img/photo/mentorThumb.png' /><div><h1>Oliver Denver</h1><p>Lawyer</p><p>Shoreditch, London</p></div></div>"
			});
