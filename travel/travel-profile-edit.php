...
<html>
	...
	<body>
		...
		<div id="ang-pageWrap">
			...
			<div id="ang-wrapper">
				<?php include '../_/inc/sidebar-travel-edit.php' ?>
				<section>
					<div id="ang-mainContent">
						...
						<div id="ang-panels">
							<div id="ang-switchContainer">
								<h1>Would you like to be a host?</h1>
							...
							<div id="ang-pTravelBio" class="ang-panelWide">
								...
								<div class="ang-pContent ang-editMode">
									<form>
										...
										<label>Allow users to see my host summary</label>
							...
							<div id="ang-pTravelServices" class="ang-panel">
								...
								<div class="ang-pContent ang-editMode">
									<form>
										...
										<input type="checkbox" value="For a drink" />
										<label>For a drink</label>
										<input type="checkbox" value="For a coffee" />
										<label>For a coffee</label>
										<button class="ang-resetEdit">Reset</button>
										<button class="ang-cancelEdit ang-red">Cancel</button>
										<button class="ang-saveEdit ang-green">Save</button>
									</form>
							...
							<div id="ang-pTravelGroups" class="ang-panel">
								...
								<div class="ang-pContent ang-normalMode">
									<a href="travel-group-edit.php" class="ang-groupBox">
										<div>
