	...
	<body>
		...
		<div id="ang-pageWrap">
			...
			<div id="ang-wrapper">
				<section>
					<!-- start: manageGroups -->
					<div id="ang-manageGroups">
						<h1>Manage Groups</h1>
						<select>
							<option selected>The Cambridge Technopole Group</option>
					...
					<div id="ang-panelsFull">
						...
						<!-- start: GroupManager -->
						<div id="ang-pGroupManager" class="ang-panelHalf">
							<div class="ang-pHeader ang-sGradient">
								<h1>Group manager</h1>
							</div>
							<div class="ang-pContent ang-normalMode">
								<div id="ang-gManagerProfile">
									<img src="../_/img/photo/mentorThumb130-1.png" />
									<div>
										<h2>Ashley Mosuro</h2>
										<h3>Web Designer</h3>
										<p>I have over 4 years experience planning, designing and developing websites for a number of corporate clients. I am able to provide help with those looking to start out in the web design industry<a href="#">...read more</a></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="ang-pCurrentMembers" class="ang-panelHalf">
							<div class="ang-pHeader ang-sGradient">
